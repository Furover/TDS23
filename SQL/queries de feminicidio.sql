...
from (
  select case  
	when HORA_FATO like '6%AM' and HORA_FATO != '6:00:00 AM' OR HORA_FATO LIKE '7%AM' OR
    HORA_FATO LIKE '8%AM' OR HORA_FATO LIKE '9%AM' OR
    HORA_FATO LIKE '9%AM' OR HORA_FATO LIKE '11%AM' OR HORA_FATO LIKE '12:00:00 PM' OR HORA_FATO LIKE 'PELA MANHÃ'
    then 'De manhã'
	when HORA_FATO LIKE '12%PM' and HORA_FATO != '12:00:00 PM' OR HORA_FATO LIKE '1%PM' OR HORA_FATO LIKE '2%PM' OR
    HORA_FATO LIKE '3%PM' OR HORA_FATO LIKE '4%PM' OR
    HORA_FATO LIKE '5%PM' OR HORA_FATO LIKE '6:00:00 PM' OR HORA_FATO LIKE 'A TARDE' then 'De tarde'
    when HORA_FATO LIKE '6%PM' and HORA_FATO != '6:00:00 PM' OR HORA_FATO LIKE '7%PM' OR HORA_FATO LIKE '8%PM' OR
    HORA_FATO LIKE '9%PM' OR HORA_FATO LIKE '10%PM' OR
    HORA_FATO LIKE '11%PM' OR HORA_FATO LIKE '12:00:00 AM' OR HORA_FATO LIKE 'A NOITE' then 'De noite'
    when HORA_FATO like '12%AM' and HORA_FATO != '12:00:00 AM' OR HORA_FATO LIKE '1%AM' OR HORA_FATO LIKE '2%AM' OR
    HORA_FATO LIKE '3%AM' OR HORA_FATO LIKE '4%AM' OR
    HORA_FATO LIKE '5%AM'OR
    HORA_FATO LIKE '6:00:00 AM' OR HORA_FATO LIKE 'DE MADRUGADA' then 'De madrugada'
    when HORA_FATO lIKE 'em hora incerta' then 'Hora incerta'
	else 'Dado rougue' end as range
  from TabelaGrande) t
group by t.range
