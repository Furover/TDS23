...
<body>
  ...
  <div class="main_body_content">
        ...
        <div class="row">
          <div class="col-md-6">
            <div class="detail-box">
              ...
              <p>
                Vendemos chocolate da mais altissima qualidade que podemos, com hidrolise injetada e um pouco de plastico (não venenoso) e também pode conter um pouco de cacau e leite, nosso objetivo é dominação mundial e intoxicação do mundo por micro-plásticos >:3
              </p>
            </div>
          </div>
          <div class="col-md-6">
    ...
    <section class="chocolate_section "  id="chocolates">
      <div class="container">
        <div class="heading_container">
          <h2>
