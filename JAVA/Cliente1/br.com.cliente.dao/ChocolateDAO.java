...
public class ChocolateDAO extends ConnectionFactory {
	   ...
	   public void insertUser(Chocolate chocolate) throws SQLException {
	   ...
	   public Chocolate selectUser(int id) {
	   ...
	   public List<Chocolate> selectAllUsers() {
	   ...
	   public boolean updateUser(Chocolate choco) throws SQLException {
	       boolean rowUpdated;
	       try (Connection connection = getConnection();
	               PreparedStatement statement = connection.prepareStatement(UPDATE_CHOCOS_SQL);) {
	           statement.setString(1, choco.getName());
	           statement.setString(2, choco.getEmail());
	           statement.setString(3, choco.getPais());
	           statement.setInt(4, choco.getId());
